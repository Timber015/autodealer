[autodealer_test.py](https://github.com/user-attachments/files/26841815/autodealer_test.py)
"""
...
SUBMIT_SELECTORS = [
    ...
    'form.auth-form input.auth__btn-hidden',
]
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        print("\n[3/4] Отправляю форму...")
        # Пробуем клик по submit; если не сработает — нажимаем Enter на поле пароля
